...
{
    public required ProviderAuthErrorData Data { get; set; }
}
...
{
    public required UnknownAssistantErrorData Data { get; set; }
}

public sealed class UnknownAssistantErrorData
{
    public required string Message { get; set; }
...
{
    public OutputLengthErrorData Data { get; set; } = new();
}

public sealed class OutputLengthErrorData { }

public sealed class AbortedError : AssistantError
{
    public required AbortedErrorData Data { get; set; }
}

public sealed class AbortedErrorData
{
    public required string Message { get; set; }
}
...
{
    public required StructuredOutputErrorData Data { get; set; }
}

public sealed class StructuredOutputErrorData
{
    public required string Message { get; set; }
...
{
    public required ContextOverflowErrorData Data { get; set; }
}

public sealed class ContextOverflowErrorData
{
    public required string Message { get; set; }
...
{
    public required ContentFilterErrorData Data { get; set; }
}

public sealed class ContentFilterErrorData
{
    public required string Message { get; set; }
}
...
{
    public required ApiAssistantErrorData Data { get; set; }
}

public sealed class ApiAssistantErrorData
{
    public required string Message { get; set; }
