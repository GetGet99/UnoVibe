...
[QuickMarkup("""
    ...
    """)]
public partial class SessionsStateProvider
{
    ...
    void Ctor(OpencodeConnection connection, EventsProvider events, ToastsProvider toasts, NotificationProvider notification, DispatcherQueue dispatcher) {
